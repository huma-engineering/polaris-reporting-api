...
This repository is transferred from [gdm-SynseneHealth](https://github.com/sensynehealth/polaris-reporting-api) to Huma organisation as part of change in asset ownership 
...
The Reporting API is part of the Polaris platform (formerly DHOS). This a service to allow Post Market Clinician Follow-up (PMCF) reporting. 
The service will gather aggregate data from each Trust.

The service transforms the data to facilitate generation of reports.

The service is multi-tenanted and gathers data from all Trusts to the same central store.
...
<!-- markdown-swagger -->
 ...
 `/dhos/v1/weekly_active_patients` | PUT    | No    |                                                                         
 `/dhos/v1/weekly_active_patients` | GET    | No    |                                                                         
 `/dhos/v1/daily_created_patients` | PUT    | No    |                                                                         
 `/dhos/v1/daily_created_patients` | GET    | No    |                                                                         
<!-- /markdown-swagger -->
...
## Database
Reporting information is stored in a Postgres database.
